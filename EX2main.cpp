...
//I forget exactly what the quote we were supposed to say about academic honesty
//But the test was my own work and I did not get information from anyone else on this Exam.
...
int** fillArray(unsigned int numRows, unsigned int numCols)
{
    ...
    for (unsigned int i = 0; i < numRows; i++) {
        ...
        //and 2) assign it the current row of your array.
